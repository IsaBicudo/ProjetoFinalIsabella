...
namespace ProjetoFinalIsabella.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "TipoProcedimentoId", "TipoProcedimentoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoObservacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "TipoProcedimentoId", "TipoProcedimentoNome", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int ProcedimentoId, [Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoObservacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            if (ProcedimentoId != procedimento.ProcedimentoId)
            {
                return NotFound();
            }
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteConfirmed(int ProcedimentoId)
        {
            if (_context.Procedimento == null)
            {
                return Problem("Entity set 'Contexto.Procedimento'  is null.");
            }
            var procedimento = await _context.Procedimento.FindAsync(ProcedimentoId);
            if (procedimento != null)
            {

...
namespace ProjetoFinalIsabella.Controllers
{
    public class CidadeController : Controller
    {
        ...
        {
            ViewData["EstadoId"] = new SelectList(_context.Set<Estado>(), "EstadoId", "EstadoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CidadeId,CidadeNome,EstadoId")] Cidade cidade)
        {
            ...
            ViewData["EstadoId"] = new SelectList(_context.Set<Estado>(), "EstadoId", "EstadoNome", cidade.EstadoId);
            return View(cidade);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int CidadeId, [Bind("CidadeId,CidadeNome,EstadoId")] Cidade cidade)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteConfirmed(int CidadeId)
        {

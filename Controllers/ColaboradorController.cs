...
namespace ProjetoFinalIsabella.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.Set<TipoColaborador>(), "TipoColaboradorId", "TipoColaboradorNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorId,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.Set<TipoColaborador>(), "TipoColaboradorId", "TipoColaboradorNome", colaborador.TipoColaboradorId);
            return View(colaborador);
        }

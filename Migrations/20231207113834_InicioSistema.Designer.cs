...
namespace ProjetoFinalIsabella.Migrations
{
    ...
    [Migration("20231207113834_InicioSistema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Cidade", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Colaborador", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Estado", b =>
                {
                    b.Property<int>("EstadoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.LocalRealizacao", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Procedimento", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.ProcedimentoRealizacao", b =>
                {
                    b.Property<int>("ProcedimentoRealizacaoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ProcedimentoRealizacaoId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProcedimentoRealizacaoId"), 1L, 1);
                    ...
                    b.HasKey("ProcedimentoRealizacaoId");
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.TipoColaborador", b =>
                {
                    b.Property<int>("TipoColaboradorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("TipoProcedimentoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalIsabella.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalIsabella.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalIsabella.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalIsabella.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalIsabella.Models.ProcedimentoRealizacao", b =>
                {
                    b.HasOne("ProjetoFinalIsabella.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalIsabella.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalIsabella.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalIsabella.Models.Procedimento", "Procedimento")
                        .WithMany()
